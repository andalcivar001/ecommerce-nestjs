...
npm install --save @nestjs/typeorm typeorm mysql2 .. para instalar orm de mysql
npm i --save class-validator class-transformer .. nos permite realizar validaciones sobre los campos a la hora de realizar una transaccion
